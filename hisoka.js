...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/badb018177664ea8d3116.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n┌── 「 *Sewa Bot* 」\n├ Trial 1 Jam\n├ 2 Minggu 10k\n├ 1 Bulan 15k\n├ Permanen 35k\n└───────\n\nPembayaran via Gopay\nUntuk lebih jelasnya bisa chat owner\nhttps://wa.me/6282140059454?text=Assalamualaikum\n\n┌〔 Donasi 〕\n├ GOPAY : 082140059454\n├ DANA : 085648267676\n└────\n\nDonasi bg Biar Bot Nya on 24Jam` }, { quoted: m }) 
            }
            break
            case 'sc': {
...
break
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                callButton: {
                                    ...
                                    phoneNumber: 'Wa.me/6282140059465'
                                }
                            }, {
                                quickReplyButton: {
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                ...
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: 'Wa.me/6282140059454'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Status Bot',
...
break
            case 'menu': case 'help': {
                buffer = await getBuffer(`https://telegra.ph/file/badb018177664ea8d3116.jpg`)
                anu = `
┌───「 *Status* 」───⭓                
│
...
`
            ...
            "urlButton": {
              ...
              "url": "https://chat.whatsapp.com/EthkDwgA3cT2TPGJmHbjgT"
            }
          },
          {
            "callButton": {
              "displayText": "Call Owner",
              "phoneNumber": "Wa.me/6282140059455"
            }
          },
          {
            "quickReplyButton": {
